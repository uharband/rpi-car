...
function turnOn(callback){
	...
	shell.exec('/usr/local/bin/mjpg_streamer -i "/usr/local/lib/input_uvc.so -y -r 352x288" -o "/usr/local/lib/output_http.so -w /usr/local/www" ', function(code, stdout, stderr) {
