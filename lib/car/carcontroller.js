...
var right_forward = 32;	// IN1 - Forward Drive
var right_backward = 33;	// IN2 - Reverse Drive
// Motor B, Left Side GPIO CONSTANTS
var left_forward = 12;	// IN1 - Forward Drive
var left_backward = 35;	// IN2 - Reverse Drive
...
function rightForwardNormal() {
    ...
    setupPinAsNormal(right_forward, voltage.high);
...
function rightBackwardsNormal() {
    ...
    setupPinAsNormal(right_backward, voltage.high);
...
function leftForwardNormal() {
    ...
    setupPinAsNormal(left_forward, voltage.high);
...
function leftBackwardsNormal() {
    ...
    setupPinAsNormal(left_backward, voltage.high);
